...
=======================================
One-time script to scan OpenMoji and Heroicon asset folders and create
...
OPENMOJI_DIR = os.path.join(BASE_DIR, 'openmoji-72x72-color')
HEROICON_DIR = os.path.join(BASE_DIR, 'heroicons_24x24')
...
def main():
    ...
    print(f"   Total vocabulary:  {len(emoji_index) + len(heroicon_index)}")
    print("=" * 60)
