...
- keep add data you generate timestamped like plan and walkthrough in markdown files each in the corresponding file  in project root for future need documents.
